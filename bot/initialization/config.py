...
class BotConfig:
    def __init__(self):
        try:
            ...
            self.admin_panel_webhook = env.str("ADMIN_PANEL_WEBHOOK", "")
            self.admin_panel_webhook_secret = env.str("ADMIN_WEBHOOK_SECRET", "")
            self.admin_webhook_secret = env.str("ADMIN_WEBHOOK_SECRET", "")
